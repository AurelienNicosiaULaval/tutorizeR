---
title: "Teaching Workflow Case Study"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Teaching Workflow Case Study}
...
```{r eval=FALSE}
work_dir <- file.path(tempdir(), "tutorizeR-case-study")
...
This workflow demonstrates feasibility and reproducibility, not measured learning impact. Formal learning-outcome evaluation has not yet been conducted, unless evidence is added to the repository. Classroom deployment is not verifiable from repository contents.
