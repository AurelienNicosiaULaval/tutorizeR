...
| MAJOR | Claiming CI is green without checking remote Actions. | Use `Not verifiable from repository contents.` unless checked live. |
...
- [ ] Confirm remote GitHub Actions pass on the final submitted branch.
