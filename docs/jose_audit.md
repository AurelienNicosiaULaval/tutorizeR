...
- Educational adoption evidence: Not verifiable from repository contents.
...
- CRAN status: Not verifiable from repository contents.
...
- Open repository: PARTIAL. Public visibility and GitHub history: Not verifiable from repository contents.
...
- Recent use in teaching and learning situations: PARTIAL. Concrete adoption evidence: Not verifiable from repository contents.
...
- Scholarly significance outside a single local use case: PARTIAL. External adoption: Not verifiable from repository contents.
...
- Reverse dependency checks: Not verifiable from repository contents.
